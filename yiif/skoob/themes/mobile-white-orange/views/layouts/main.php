  ...
  <body class="home blog"> 
    <div id="wrapper"> 
      ...
      <a id="logo" href="" title="<?php echo Yii::app()->name ?>"> 
        <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/logo_desktop.png" alt="Simple Mobile" /> 
      </a> 
      <!-- END LOGO --> 
      ...
      <!-- BEGIN HEADER --> 
			<div class="pageHead">
				<div class="logoBlock">
					<img id="header" src="<?php echo Yii::app()->theme->baseUrl?>/images/logo_desktop.png" alt="" /> 
				</div>
			</div>
